...
public class Rail : MonoBehaviour {
    ...
    public Vector3 PositionOnRail(int seg, float ratio, PlayMode mode)
    {
        switch(mode)
        {
            ...
            case PlayMode.Catmull:
                return CatmullPosisition(seg, ratio);
        }
    }
    ...
    public Vector3 CatmullPosisition(int seg, float ratio)
    {
        Vector3 p1, p2, p3, p4;
